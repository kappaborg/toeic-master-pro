    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'test.partLabel': 'Part {part}',
                'test.play': 'Play Audio',
                'test.replay': 'Replay',
                'test.playing': 'Playing...',
                'test.replaysLeft': 'Replays left: {count}',
                'test.noReplays': 'No replays left',
                'test.listenCarefully': 'Listen carefully — the audio is played only, never shown as text.',
                'test.part1Instr': 'Look at the picture and listen to the four statements. Choose the statement that best describes the picture.',
                'test.part2Instr': 'Listen to the question and the three responses. Choose the best response.',
                'test.part3Instr': 'Listen to the conversation, then answer the question below.',
                'test.part4Instr': 'Listen to the talk, then answer the question below.',
                'test.part5Instr': 'Choose the word or phrase that best completes the sentence.',
                'test.part6Instr': 'Read the text and choose the best answer for each blank.',
                'test.part7Instr': 'Read the text(s) below and choose the best answer to the question.',
            ...
            'zh-CN': {
                ...
                'test.partLabel': '第 {part} 部分',
                'test.play': '播放音频',
                'test.replay': '重听',
                'test.playing': '播放中...',
                'test.replaysLeft': '剩余重听次数：{count}',
                'test.noReplays': '重听次数已用完',
                'test.listenCarefully': '请仔细听——音频只播放，不会以文字显示。',
                'test.part1Instr': '看图片并听四个句子，选择最能描述图片内容的句子。',
                'test.part2Instr': '听问题和三个回答，选择最合适的回答。',
                'test.part3Instr': '听对话，然后回答下面的问题。',
                'test.part4Instr': '听短文，然后回答下面的问题。',
                'test.part5Instr': '选择最能补全句子的单词或短语。',
                'test.part6Instr': '阅读短文，为每个空格选择最佳答案。',
                'test.part7Instr': '阅读下面的文章，选择问题的最佳答案。',
